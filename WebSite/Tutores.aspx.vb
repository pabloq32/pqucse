...
Partial Class Default2
    ...
    End Sub
    Protected Sub bttnagregar_Click(sender As Object, e As System.EventArgs) Handles bttnagregar.Click
        Me.bttnaceptar.Enabled = True
        Me.bttncancelar.Enabled = True
        activarcampos()
        Me.bttnmodificar.Enabled = False
    ...
    Protected Sub bttnaceptar_Click(sender As Object, e As System.EventArgs) Handles bttnaceptar.Click
            ...
            If Me.bttneliminar.Enabled = False Then
                Try
                    ...
                    If b = 0 Then
                        ...
                        ocdtutores.InsertarTutor(TextBox1.Text, TextBox11.Text)
            ...
            Else
                ...
                Try
                    ...
                    Else
                        ...
                        ocdtutores.EliminarTutor(TextBox1.Text)
